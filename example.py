...
def update_elo_score(score1, score2, outcome):
...
def main():
    ...
    if args.command == "insert":
        ...
        new_score1, new_score2 = update_elo_score(score1, score2, args.winner)
        ...
        for i in range(len(all_objects)):
            for j in range(i + 1, len(all_objects)):
                ...
                new_score1, new_score2 = update_elo_score(score1, score2, result)
        ...
        for obj in sorted_objects:
            print(f"Object ID: {obj['object_id']}, {dimension}: {obj.get(dimension, DEFAULT_ELO)}")
